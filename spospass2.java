...
public class prc {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ic.length; i++) {
            String opcodePart = ic[i][0];
            String operand1 = ic[i][1];
            String operand2 = ic[i][2];

            String instrClass = opcodePart.substring(1, 3);
            String instrCode = opcodePart.replaceAll("[^0-9]", "");

            if (instrClass.equals("IS")) {
                System.out.print(instrCode + "\t");
                ...
                if (operand2 != null) {
                    ...
                    if (operandType == 'S') {
                        System.out.print(s[operandIndex].addr);
                    } else if (operandType == 'L') {
                        System.out.print(l[operandIndex].addr);
                    }
                } else {
            ...
            } else if (instrClass.equals("DL")) {
                if (instrCode.equals("01")) {
                    System.out.print("00\t00\t");
                    String constant = operand2.replaceAll("[^0-9]", "");
                    System.out.println(df.format(Integer.parseInt(constant)));
                }
            }
        }
    }
